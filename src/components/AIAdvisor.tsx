...
export const AIAdvisor = () => {
  ...
  // Usar sempre a carteira default (primeira disponível)
  const activeGroup = currentGroup || groups[0] || null;
  ...
  useEffect(() => {
    if (showHistory && activeGroup) {
      fetchHistoryList(activeGroup);
    }
  }, [showHistory, activeGroup]);
